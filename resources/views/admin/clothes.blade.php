            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="active"><a href="{{ url('admin/clothes') }}"><i class="icon mdi mdi-face"></i><span>Clothes</span></a>
                  </li>
 ...
 --}}
  ...
  @endif
       ...
       <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Clothes</h2>
                ...
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    @endif
                              ...
                              <td> <button class="btn btn-warning btn-xs btn-detail open-modal" value="{{$cloth->id}}"><i class="fa fa-edit"></i>Edit</button>
                            @if( Auth::user()->admin == 1)
                            <button class="btn btn-danger btn-xs btn-delete delete-task" value="{{$cloth->id}}">Delete</button>
                            @endif  
      ...
      $('.open-modal').click(function(){
        ...
        $.get(url + '/' + task_id, function (data) {
           ...
           // console.log(data);
            ...
            $('#modaltitle').text('Update Cloth Details');
            $('#save').val("update");
      ...
      <div class="modal-dialog custom-width">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Pieces</label>
              <input type="text" id="pieces" placeholder="Enter Number of Pieces" class="form-control">
            </div>
            <div class="form-group">
