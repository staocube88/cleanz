              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li><a href="{{ url('admin/services') }}"><i class="icon mdi mdi-face"></i><span>Services</span></a>
                      ...
                      <li class="active"><a href="{{ url('admin/customers') }}"><i class="icon mdi mdi-face"></i><span>Customers</span></a>
                      </li>
                ...
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    @endif
                              ...
                              <td> <button class="btn btn-warning btn-xs btn-detail open-modal" value="{{$customer->id}}"><i class="fa fa-edit"></i>Edit</button>
                              @if( Auth::user()->admin == 1)
                             <button class="btn btn-danger btn-xs btn-delete delete-task" value="{{$customer->id}}">Delete</button>
                             @endif
                              </td>
...
@section('script')
   <script src="{{ asset('assets/lib/jquery/jquery.min.js') }}" type="text/javascript"></script>
    ...
    $('.open-modal').click(function(){
        ...
        $.get(url + '/' + task_id, function (data) {
           ...
           $('#customer_id').val(data.id);
            ...
            $('#modaltitle').text('Update Customer Details');
            $('#save').val("update");
    ...
    $('#btn-new').click(function(){
      ...
      var url = "/admin/api/getcustomerID";
    ...
    $('#btn-success').on('click', function(event) {
          var url = "http://localhost:8000/admin/customers";
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" id="staff" value="{{ Auth::user()->name }}" class="form-control">
             <input type="hidden" id="customer_id" value="" class="form-control">
           
           <div class="form-group">
              <label>Customer ID</label>
              <input type="text" id="cust_id" class="form-control input-xs" disabled>
            </div>
            <div class="row no-margin-y">
              <div class="form-group col-xs-3">
                <label>Title</label>
                <select class="form-control input-xs" id="title">
              ...
              <label>Name</label>
                <input type="text" id="name" placeholder="Enter Name" class="form-control input-xs">
              </div>
            </div>
            <div class="form-group">
              <label>Mobile</label>
              <input type="text" id="mobile" placeholder="Enter Mobile number" class="form-control input-xs">
            </div>
            <div class="form-group">
              <label>Email</label>
              <input type="text" id="email" placeholder="Enter email" class="form-control input-xs">
            </div>
            <div class="form-group">
              <label>Address</label>
              <input type="text" id="address" placeholder="Enter address" class="form-control input-xs">
            </div>
            <div class="form-group">
              <label>Discount</label>
              <input type="text" id="discount" placeholder="Enter discount" class="form-control input-xs">
            </div>
          </div>
