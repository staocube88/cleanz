                ...
                <div class="panel-body">
                  <form class="form-horizontal">
                    <div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-10">
                        <input id="inputEmail3" type="email" placeholder="Email" class="form-control input-xs">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
                      <div class="col-sm-10">
                        <input id="inputPassword3" type="password" placeholder="Password" class="form-control input-xs">
                      </div>
                    </div>

                    <div class="form-group xs-pt-15">
                      <label for="inputEmail3" class="col-sm-2 control-label">Received</label>
                        <div data-min-view="2" data-date-format="yyyy-mm-dd" class="col-md-9 input-group date datetimepicker">
                          <input  type="text" id="receivedate" value="" class="form-control input-xs"><span class="input-group-addon btn btn-primary"><i class="icon-th mdi mdi-calendar"></i></span>
                      </div>
                  </div>
