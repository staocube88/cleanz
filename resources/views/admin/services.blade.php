            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="active"><a href="{{ url('admin/services') }}"><i class="icon mdi mdi-face"></i><span>Services</span></a>
                      </li>
                ...
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    @endif
                          ...
                          @if( Auth::user()->admin == 1)    
                              <td> <button class="btn btn-warning btn-xs btn-detail open-modal" value="{{$service->id}}"><i class="fa fa-edit"></i>Edit</button>
                                                        
                             <button class="btn btn-danger btn-xs btn-delete delete-task" value="{{$service->id}}">Delete</button>
                              </td>
                          @endif
...
@section('script')
   <script src="{{ asset('assets/lib/jquery/jquery.min.js') }}" type="text/javascript"></script>
    ...
    $('.open-modal').click(function(){
        ...
        $.get(url + '/' + task_id, function (data) {
           ...
           // console.log(data);
            ...
            $('#modaltitle').text('Update services');
            $('#save').val("update");
    ...
    $('#btn-new').click(function(){
        ...
        $('#modaltitle').text('Add New Services');
        $('#mod-success').modal('show');
    });


    $('#btn-success').on('click', function(event) {
          var url = "http://localhost:8000/admin/services";
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" id="staff" value="{{ Auth::user()->name }}" class="form-control">
             <input type="hidden" id="service_id" value="" class="form-control">
