...
<html lang="en-US">
<head>
    <title>Cleanrite Maintenance Services</title>
   ...
   <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/linea-icon.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('css/fancy-buttons.css') }}"/>
...
<body>
    ...
    <div id="header" class="header-section">
                ...
                <div id="topbar-hold" class="nav-hold container">
                    <nav class="navbar" role="navigation">
                        <div class="navbar-header">
                            ...
                            <!--=== Site Name ===-->
                            <a class="site-name navbar-brand" href="#"><span>C</span>leanrite Maintenance</a>
                        </div>
        ...
        <div id="section-home" class="home-section-wrap center">
            ...
            <div class="container home">
                <div class="row">
                    <h1 class="well-come">Welcome to a home of branding</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInLeft" data-animation-delay="700">
                    ...
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Laundry/Laundromat</h4>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    ...
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Dry Cleaning</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInRight" data-animation-delay="700">
                    ...
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">After Event Clean-up Service</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    ...
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Laundry Equipment Sales and Repairs</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    <span class="service-icon center"><i class="icon icon-basic-lightbulb fa-3x"></i></span>
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Integrated House Cleaning</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    <span class="service-icon center"><i class="icon icon-basic-lightbulb fa-3x"></i></span>
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Interior and Exterior Decoration</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    <span class="service-icon center"><i class="icon icon-basic-lightbulb fa-3x"></i></span>
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Waste Disposal and Recycling</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
                ...
                <div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
                    <span class="service-icon center"><i class="icon icon-basic-lightbulb fa-3x"></i></span>
                    <div class="service-desc">
                        <h4 class="service-title color-scheme">Janitorial Services</h4>
                        <p class="service-description justify">
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                            Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 step-desc">
                    ...
                    <div class="col-md-10 step-details">
                            <h3 class="step-title color-scheme">Mission</h3>
                            <p class="step-description">Our mission is to provide our client
                                with the best services in fabric care.</p>

                                <h3 class="step-title color-scheme">Vision</h3>
                                <p class="step-description">Our vision is to be the best in the cleaning industry with state of the art equipment, innovation
                                and best quality service delivery</p>
                ...
                <div class="col-md-4 step-img">
                    <img src="images/machine.jpg" alt="" /> <!-- Step Photo Here -->
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="section-overlay"></div>
        ...
        <div class="col-md-6">
           <div class="contact_text">
             <h3>Head Office</h3>
               <p class="pclass">Cleanrite building, beside St. Mark Anglican Church, Aregbe, Abeokuta.</p>
               <br>
               <h3>Branch Offices</h3>

                 <p class="pclass">Behind Local Govt. Market, Gbonagun, Obantoko, Abeokuta</p>
                 <p class="pclass">Anjorin plaza, opposite Madojutimi, along Aladesanmiroad, Abiola way, Abeokuta</p>
                 <p class="pclass">10, kemta Oloko, Opposite MOSBE plaza, Sapon, Abeokuta.</p>
           </div>
       </div>
            </div>
        </div>
    ...
    <div id="section-footer" class="footer-wrap">
        <div class="container footer center">
          ...
          <p class="copyright left bottom">All rights reserved &copy; 2017</p>
                    <!-- Social Links -->
              ...
              <li><a href="#"><i class="fa fa-instagram-square"></i></a></li>
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <ul class="contact_info">
                            <li>info@cleanritemaintenance.com</li>
                            <li>+2348164367603, +2349084647300</li>
                    </ul>
                </div>
            </div>
        </div>
